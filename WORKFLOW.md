...
> **Basado en**: `ARCH BASE ORIGINALES/WORKFLOW_TEMPLATE.md`
...
### Paso 5 — COMMIT
```bash
git add . && git commit -m "tipo: descripción breve (ref: logs/YYYY-MM-DD-...)" && git push
```
...
| Commits | `docs + feat: vX.X.X` para docs, `feat: vX.X.X — descripción` para código |
