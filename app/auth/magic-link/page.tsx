...
/**
 * Magic Link — entrada sin fricción para consultantes.
 * Solo pide email. Supabase envía un enlace de un solo uso.
 * Sin contraseña. Sin formulario de registro.
 */
        ...
        {success ? (
          ...
          <div style={{ textAlign: "center" }}>
            ...
            >
              ...
              <strong style={{ color: "var(--nv-text-primary)" }}>{email}</strong>.
            </p>
            <p
              style={{
                fontSize: 12,
            ...
            >
              Abrí el email, tocá el botón y ya estás adentro.
              Sin contraseña. Sin formularios.
              <br />
